...
$str1="select * from manage_category where currency='Party Rental' group by price";
...
?>
	...
	<a href="categories_party.php?subsubcat=<?php echo $row_subcat['price2'] ?>"> <?php echo $row_subcat['price2']?> </a>
...
<?php	
			...
			$str_1="select * from books where subcat='$subcat' and catid ='Party Rental' order by bookname LIMIT $offset, $rowsPerPage";
	...
	<div class="prds_img">
    	...
    	<a href="product-details-party.php?id=<?php echo $row['bid'] ?>">
    ...
    <?php
				...
				$qryapp="where subcat='$subcat' and catid ='Party Rental'";
            ...
            <div style="width:450px; color:#930; margin-left:25px;margin-bottom: 8px; font-size:24px">page: 
            ...
            <?php
...

				{
					...
					$nav.="&nbsp;<a class='paging' href=\"$self?pg=$tt&countstart=$tt1&cat=$cat&subsubcat=$subcat_pro&curcode=$curcode\"><<</a>&nbsp;";
...

				{
...

					{
						...
						$nav.="<a class='paging' href=\"$self?pg=$j&countstart=$countstart&cat=$cat&subsubcat=$subcat_pro&curcode=$curcode\">

					            <font style='color: #ff0000; font-weight:bold;font-size:22px'>$j</font></a> ";
...

				{
					...
					$nav.="&nbsp;<a  href=\"$self?pg=$j&countstart=$temp&cat=$cat&subsubcat=$subcat_pro&curcode=$curcode\">>></a>&nbsp;";

					$nav.="&nbsp;<a  href=\"$self?pg=$maxPage&countstart=$temp1&cat=$cat&subsubcat=$subcat_pro&curcode=$curcode\">>|</a>&nbsp;";
